...
public class StatementParser extends BaseParser {
    ...
    public StmtNode parseStatement() throws ParserException {
        try {
            ...
            throw new ParserException("Error parsing statement: " + e.getMessage());
        }
    }
    ...
    public LetStmtNode parseLetStatement() throws ParserException {
        try {
            ...
            throw new ParserException("Error parsing let statement: " + e.getMessage());
        }
    }
    ...
    public FunctionNode parseFunctionStatement() throws ParserException {
        try {
            ...
            throw new ParserException("Error parsing function statement: " + e.getMessage());
        }   
    }
    ...
    public ParameterNode parseParameter() throws ParserException {
        try {
            ...
            throw new ParserException("Error parsing parameter: " + e.getMessage());
        }
    }
    ...
    public StructNode parseStructStatement() throws ParserException {
        try {
            ...
            throw new ParserException("Error parsing struct statement: " + e.getMessage());
        }
    }
    ...
    public FieldNode parseFieldNode() throws ParserException {
        try {
            ...
            throw new ParserException("Error parsing field node: " + e.getMessage());
        }
    }
    ...
    public EnumNode parseEnumStatement() throws ParserException {
        try {
            ...
            throw new ParserException("Error parsing enum statement: " + e.getMessage());
        }
    }
    ...
    public ConstItemNode parseConstStatement() throws ParserException {
        try {
            ...
            throw new ParserException("Error parsing const statement: " + e.getMessage());
        }
    }
    ...
    public TraitNode parseTraitStatement() throws ParserException {
        try {
            ...
            throw new ParserException("Error parsing trait statement: " + e.getMessage());
        }
    }
    ...
    public ImplNode parseImplStatement() throws ParserException {
        try {
            ...
            throw new ParserException("Error parsing impl statement: " + e.getMessage());
        }
    }
    ...
    public AssoItemNode parseAssoItemNode() throws ParserException {
        try {
            ...
            throw new ParserException("Error parsing associated item: " + e.getMessage());
        }
    }
    ...
    public ExprStmtNode parseExpressionStatement() throws ParserException {
        try {
            ...
            if (currentToken.name.equals("if") ||
                ...
                // Check if the parsed expression is null
                if (expr == null) {
                    throw new ParserException("Expected expression but found: " + tokenStream.current().name);
                }
            ...
            throw new ParserException("Error parsing expression statement: " + e.getMessage());
        }
    }
}
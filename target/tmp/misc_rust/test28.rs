...
impl Trie {
    ...
    fn insert(&mut self, word: &[i32; 100], length: i32) {
    ...
    fn search(&self, word: &[i32; 100], length: i32) -> bool {
        let mut current: i32 = self.root;
    ...
    fn starts_with(&self, prefix: &[i32; 100], length: i32) -> bool {
        let mut current: i32 = self.root;
    ...
    fn delete_helper(&mut self, node: i32, word: &[i32; 100], depth: i32, length: i32) -> bool {
        if (depth == length) {
    ...
    fn delete(&mut self, word: &[i32; 100], length: i32) {
        self.delete_helper(self.root, word, 0, length);
    }
    
    fn count_words_with_prefix(&self, prefix: &[i32; 100], length: i32) -> i32 {
        let mut current: i32 = self.root;
